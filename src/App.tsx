...
import { DependentsDeductionPanel } from './components/views/DependentsDeductionPanel';
...
import { CustomerConsultationForm } from './components/views/CustomerConsultationForm';
            ...
            {currentView === 'registration' && (
              <div className="view-container" style={{ backgroundColor: '#ffffff', padding: '20px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px', marginTop: '12px', marginBottom: '8px' }}>
                 ...
                 {/* Bottom Row split: Left Customer consultation details, Right Logs, Consent, Invoices */}
