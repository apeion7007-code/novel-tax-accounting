  ...
  const triggerKoreanInvoiceDownload = async () => {
    ...
    try {
      ...
      const translations: Record<string, Record<string, string>> = {
        ...
        '방글라데시어': {
          title: 'ট্যাক্স রিফান্ড সেটলমেন্ট ইনভয়েস',
          sec1: '1. গ্রাহকের বিবরণ',
          name: 'গ্রাহকের নাম',
          rrn: 'এলিয়েন রেজিস্ট্রেশন নম্বর (RRN)',
          company: 'অনুষঙ্গিক কোম্পানি',
          sec2: '2. রিফান্ড এবং ফি বিবরণ',
          year: 'নিষ্পত্তি বছর',
          expect: 'প্রত্যাশিত রিফান্ড (জাতীয় + স্থানীয় কর)',
          fee: 'এজেন্সি পরিষেবা ফি',
          total: 'মোট',
          sec3: '3. ব্যাংক অ্যাকাউন্ট এবং পেমেন্ট গাইড',
          bank: 'ব্যাংকের নাম',
          acc: 'অ্যাকাউন্ট নম্বর',
          owner: 'অ্যাকাউন্টের মালিক',
          footnote: '※ এজেন্সির ফি পরিশোধ নিশ্চিত করার পর রিফান্ড আবেদন প্রক্রিয়াকরণ করা হবে।\n※ অর্থ জমা করার সময় অনুগ্রহ করে আপনার নিজের নাম ব্যবহার করুন।',
          filePrefix: 'Invoice_BD',
          wageLabel: 'বেতন আয়',
          freeLabel: 'ব্যবসায়িক আয় (3.3%)',
          feeNoticePrefix: '★ আপনার মোট প্রদেয় এজেন্সি ফি: ',
          feeNoticeSuffix: '원.'
        },
        '우즈베크어': {
          title: 'Soliqni Qaytarish Hisob-Kitob Veksili',
          sec1: '1. Mijoz haqida maʼlumot',
          name: 'Mijozning ismi',
          rrn: 'Chet el fuqarosini roʻyxatga olish raqami (RRN)',
          company: 'Kompaniya nomi',
          sec2: '2. Qaytarilgan soliq va xizmat haqi tafsilotlari',
          year: 'Hisob-kitob yili',
          expect: 'Kutilayotgan qaytarilish summasi (Milliy + Mahalliy soliq)',
          fee: 'Vositachilik xizmat haqi',
          total: 'Jami',
          sec3: '3. Bank hisob raqami va toʻlov yoʻriqnomasi',
          bank: 'Bank nomi',
          acc: 'Hisob raqami',
          owner: 'Hisob egasi',
          footnote: '※ Vositachilik xizmati toʻlovi tasdiqlangandan soʻng, soliq idorasiga yakuniy ariza topshiriladi.\n※ Pul oʻtkazishda albatta mijozning oʻz ismidan foydalaning.',
          filePrefix: 'Invoice_UZ',
          wageLabel: 'Ish haqi daromadi',
          freeLabel: 'Mustaqil daromad (3.3%)',
          feeNoticePrefix: '★ Jami toʻlanishi kerak boʻlgan xizmat haqi: ',
          feeNoticeSuffix: '원.'
        },
        '파키스탄어': {
          title: 'ٹیکس ریفنڈ ادائیگی انوائس',
          sec1: '1. کسٹمر کی معلومات',
          name: 'کسٹمر کا نام',
          rrn: 'ایلین رجسٹریشن نمبر (RRN)',
          company: 'کمپنی کا نام',
          sec2: '2. ریفنڈ اور سروس فیس کی تفصیلات',
          year: 'تصفیہ کا سال',
          expect: 'متوقع ریفنڈ (قومی + مقامی ٹیکس)',
          fee: 'ایجنسی سروس فیس',
          total: 'کل رقم',
          sec3: '3. بینک اکاؤنٹ اور ادائیگی کی ہدایات',
          bank: 'بینک का नाम',
          acc: 'اکاؤنٹ نمبر',
          owner: 'اکاؤنٹ ہولڈر کا نام',
          footnote: '※ سروس فیس کی ادائیگی کی تصدیق کے بعد ٹیکس آفس میں حتمی درخواست بھیجی جائے گی۔\n※ رقم منتقل کرتے وقت برائے مہربانی صرف کسٹمر کا اصل نام استعمال کریں۔',
          filePrefix: 'Invoice_PK',
          wageLabel: 'تنخواہ کی آمدنی',
          freeLabel: 'آزاد آمدنی (3.3%)',
          feeNoticePrefix: '★ قابل ادائیگی کل سروس فیس: ',
          feeNoticeSuffix: '원.'
        },
        '태국어': {
          title: 'ใบแจ้งหนี้การชำระเงินคืนภาษี',
          sec1: '1. ข้อมูลลูกค้า',
          name: 'ชื่อลูกค้า',
          rrn: 'เลขทะเบียนต่างด้าว (RRN)',
          company: 'ชื่อบริษัท',
          sec2: '2. รายละเอียดการคืนภาษีและค่าบริการ',
          year: 'ปีภาษี',
          expect: 'ประมาณการเงินคืนภาษี (ภาษีแห่งชาติ + ท้องถิ่น)',
          fee: 'ค่าบริการตัวแทน',
          total: 'ยอดรวม',
          sec3: '3. ข้อมูลบัญชีธนาคารและคำแนะนำการชำระเงิน',
          bank: 'ชื่อธนาคาร',
          acc: 'เลขที่บัญชี',
          owner: 'ชื่อเจ้าของบัญชี',
          footnote: '※ หลังจากยืนยันการชำระค่าบริการแล้ว การดำเนินการยื่นคำร้องต่อกรมสรรพากรจะเริ่มขึ้น\n※ กรุณาโอนเงินด้วยชื่อของลูกค้าเองเท่านั้น',
          filePrefix: 'Invoice_TH',
          wageLabel: 'รายได้จากเงินเดือน',
          freeLabel: 'รายได้อิสระ (3.3%)',
          feeNoticePrefix: '★ ยอดค่าบริการตัวแทนทั้งหมดที่ต้องชำระ: ',
          feeNoticeSuffix: '원.'
        },
        '필리핀어': {
          title: 'Invoice para sa Settlement ng Refund sa Buwis',
          sec1: '1. Impormasyon ng Kliyente',
          name: 'Pangalan ng Kliyente',
          rrn: 'Alien Registration Number (RRN)',
          company: 'Pangalan ng Kumpanya',
          sec2: '2. Detalye ng Refund at Bayad sa Serbisyo',
          year: 'Taon ng Settlement',
          expect: 'Inaasahang Refund (Pambansa + Lokal na Buwis)',
          fee: 'Bayad sa Serbisyo ng Ahensiya',
          total: 'Kabuuan',
          sec3: '3. Impormasyon sa Bank Account at Gabay sa Pagbabayad',
          bank: 'Pangalan ng Bangko',
          acc: 'Numero ng Account',
          owner: 'Pangalan ng May-ari ng Account',
          footnote: '※ Pagkatapos makumpirma ang bayad sa serbisyo, ipoproseso ang huling aplikasyon sa Refund sa Buwis.\n※ Mangyaring siguruhin na ang pangalan ng kliyente ang gagamitin sa paglipat ng pera.',
          filePrefix: 'Invoice_PH',
          wageLabel: 'Kita sa Suweldo',
          freeLabel: 'Freelance na Kita (3.3%)',
          feeNoticePrefix: '★ Kabuuang bayad sa serbisyo na dapat bayaran: ',
          feeNoticeSuffix: '원.'
        },
        '스리랑카어': {
          title: 'බදුပြန်අမ်း මුදල් පියවීම් ඉන්වොයිසිය',
          sec1: '1. පාරිභෝගික තොරතුරු',
          name: 'පාරිභෝගිකයාගේ නම',
          rrn: 'විදේශික ලියාපදිංචි අංකය (RRN)',
          company: 'සම්බන්ධිත සමාගම',
          sec2: '2. බදුပြန်අမ်း මුදල් සහ සේවා ගාස්තු විස්තරය',
          year: 'පියවීම් වර්ෂය',
          expect: 'බලාපොරොත්තු වන බදුပြန်අမ်း මුදල (ජාතික + ප්‍රාදේශීය බදු)',
          fee: 'නියෝජිත සේවා ගාස්තුව',
          total: 'එකතුව',
          sec3: '3. බැංකු ගිණුම් තොරතුරු සහ ගෙවීම් උපදෙස්',
          bank: 'බැංකුවේ නම',
          acc: 'ගිණුම් අංකය',
          owner: 'ගිණුම් හිමියාගේ නම',
          footnote: '※ සේවා ගාස්තු ගෙවීම තහවුරු කිරීමෙන් පසුව බදු කාර්යාලයට අවසන් අයදුםපත ඉදිරිපත් කෙරේ.\n※ මුදල් තැන්පත් කිරීමේදී කරුණාකර පාරිභෝගිකයාගේ නමම භාවිතා කරන්න.',
          filePrefix: 'Invoice_LK',
          wageLabel: 'වැටුප් ආදායම',
          freeLabel: 'නිදහස් ආදායම (3.3%)',
          feeNoticePrefix: '★ ගෙවිය යුතු මුළු සේවා ගාස්තුව: ',
          feeNoticeSuffix: '원.'
        },
        '영어': {
          title: 'Tax Refund Settlement Invoice',
          sec1: '1. Client Information',
          name: 'Client Name',
          rrn: 'Resident Registration Number (RRN)',
          company: 'Affiliated Company',
          sec2: '2. Refund & Fee Details',
          year: 'Settlement Year',
          expect: 'Expected Refund (National + Local Tax)',
          fee: 'Service/Agency Fee',
          total: 'Total',
          sec3: '3. Bank Account & Payment Info',
          bank: 'Deposit Bank',
          acc: 'Account Number',
          owner: 'Account Holder',
          footnote: '※ The final tax refund request will be submitted after payment of the agency fee is confirmed.\n※ Please ensure that the deposit is made under the client\'s name.',
          filePrefix: 'Invoice_EN',
          wageLabel: 'Wage Income',
          freeLabel: 'Business Income (3.3%)',
          feeNoticePrefix: '★ Total agency fee payable: ',
          feeNoticeSuffix: '원.'
        }
      };
